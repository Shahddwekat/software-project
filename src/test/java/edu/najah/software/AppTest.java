...
public class AppTest {
    ...
    @Test
    void testIsAdminFalseAfterLogout() {
        authService.login("admin", "admin123");
        authService.logout();
        assertFalse(authService.isAdmin());
    }
    ...
    // ===================== Domain Model: User, Administrator, Appointment =====================
